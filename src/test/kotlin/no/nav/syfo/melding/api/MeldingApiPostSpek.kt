...
import no.nav.syfo.melding.domain.serialize
import no.nav.syfo.melding.kafka.domain.DialogmeldingBestillingDTO
import no.nav.syfo.melding.kafka.domain.DialogmeldingKode
import no.nav.syfo.melding.kafka.domain.DialogmeldingKodeverk
