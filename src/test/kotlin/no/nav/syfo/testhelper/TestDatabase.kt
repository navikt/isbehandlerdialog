...
fun DatabaseInterface.createNMeldingTilBehandler(meldingTilBehandler: MeldingTilBehandler, numberOfMeldinger: Int = 1): UUID {
...
fun DatabaseInterface.createNMeldingFraBehandler(meldingFraBehandler: MeldingFraBehandler, numberOfMeldinger: Int = 1): UUID {
    this.connection.use { connection ->
        for (i in 1..numberOfMeldinger) {
