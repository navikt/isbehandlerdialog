...
const val KAFKA_CONSUMER_DIALOGMELDING_FRA_BEHANDLER_SKIPPED_TYPE_NOT_RELEVANT =
    "${KAFKA_CONSUMER_DIALOGMELDING_FRA_BEHANDLER_BASE}_skipped_type_not_relevant"
...
val COUNT_KAFKA_CONSUMER_DIALOGMELDING_FRA_BEHANDLER_MELDING_CREATED: Counter =
    Counter.builder(KAFKA_CONSUMER_DIALOGMELDING_FRA_BEHANDLER_MELDING_CREATED)
        ...
        .register(METRICS_REGISTRY)
val COUNT_KAFKA_CONSUMER_DIALOGMELDING_FRA_BEHANDLER_SKIPPED_TYPE_NOT_RELEVANT: Counter =
    Counter.builder(KAFKA_CONSUMER_DIALOGMELDING_FRA_BEHANDLER_SKIPPED_TYPE_NOT_RELEVANT)
        .description("Counts the number of melding skipped from topic because not relevant type - teamsykefravr.dialogmelding")
        .register(METRICS_REGISTRY)
