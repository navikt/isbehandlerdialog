...
class MeldingService(
    ...
    internal suspend fun createPaminnelse(
        ...
        val opprinneligMelding = meldingRepository.getMeldingTilBehandler(meldingUuid)
    ...
    internal suspend fun createReturAvLegeerklaring(
        ...
        val innkommendeLegeerklaring = meldingRepository.getMeldingFraBehandler(meldingUuid)
